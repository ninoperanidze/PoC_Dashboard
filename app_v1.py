...
with main_content:
    ...
    with tab1:
        ...
        with col3:
            with st.expander("Membership Period"):
                selected_membership_period = st.multiselect("Select Membership Period:", data['Membership Period'].unique(), default=data['Membership Period'].unique(), key="class_membership_period")
        ...
        with col_chart:
            ...
            filtered_data = data[
                ...
                (data['Membership Period'].isin(selected_membership_period)) &
    ...
    with tab2:
        ...
        with col3:
            with st.expander("Membership Period"):
                selected_membership_period = st.multiselect("", data['Membership Period'].unique(), default=data['Membership Period'].unique(), key="age_group_membership_period")
